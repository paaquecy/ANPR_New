...
const Sidebar: React.FC<SidebarProps> = ({ activeItem, onItemClick, onLogout, darkMode }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed left-0 top-0 h-full min-h-screen bg-white shadow-lg z-50 transition-transform duration-300 ease-in-out
        ${isMobileMenuOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}
        w-64 flex flex-col lg:static lg:transform-none
      `}>
        {/* Header */}
