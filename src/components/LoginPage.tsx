...
interface LoginPageProps {
  onLoginApp: (appType: 'admin' | 'dvla' | 'police') => void;
  onRegister: () => void;
}

const LoginPage: React.FC<LoginPageProps> = ({ onLoginApp, onRegister }) => {
  ...
  const handleLogin = (e: React.FormEvent) => {
    ...
    // Check credentials for admin and DVLA
    if (username === '4231220075' && password === 'Wattaddo020') {
      console.log('Login successful - admin credentials');
      onLoginApp('admin');
    } else if (username === '0987654321' && password === 'Bigfish020') {
      console.log('Login successful - DVLA credentials');
      onLoginApp('dvla');
    } else if (username === '1234567890' && password === 'Madman020') {
      console.log('Login successful - Police credentials');
      onLoginApp('police');
    } else {
