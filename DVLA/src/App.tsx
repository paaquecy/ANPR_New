...
function App({ onLogout, showLogin = false, onLogin }: { onLogout?: () => void, showLogin?: boolean, onLogin?: (appType: 'admin' | 'dvla' | 'police') => void }) {
  ...
  if (showLogin) {
    return <LoginPage onLoginApp={onLogin || (() => {})} onRegister={() => {}} />;
  }
